...
public class RechargeRecord extends GeneralBean {
	...
	private int orderType;					//订单类型  1.支付宝 | 2.微信
	...
	public RechargeRecord(Long playerId, String accountId, String userKey, String orderNo, int orderType, String goodID,
