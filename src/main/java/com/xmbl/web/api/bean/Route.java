...
public class Route {
	 ...
	 */
	public class Jms{
		public final static String PATH = "/jms";

		public final static String SEND_EMAIL_MESSAGE = "/send_email_message";						//获取服务器列表
	}
    ...
    public class Swagger{
        public final static String PATH = "/swagger";

        public final static String SERVER_LIST = "/getServerLst";							//发送邮件
    }
